...
let Reservation = class Reservation {
    constructor(checkin, checkout, room) {
...
__decorate([
    typeorm_1.ManyToOne(type => Rooms_1.default, room => room.reservation, { onDelete: "CASCADE" }),
    __metadata("design:type", Rooms_1.default)
], Reservation.prototype, "room", void 0);
Reservation = __decorate([
    typeorm_1.Entity("reservations"),
    __metadata("design:paramtypes", [Date, Date, Rooms_1.default])
], Reservation);
